...
export const mockWeatherResponse = {
    type: "Feature",
    geometry: { type: "Point", coordinates: [6.44, 60.66, 132] },
    properties: {
        meta: { updated_at: "2026-03-03T10:00:00Z", units: { air_temperature: "celsius" } },
        timeseries: [
            // --- TIRSDAG 3. MARS ---
            {
                ...
                "data": {
                    ...
                    "next_6_hours": { "summary": { "symbol_code": "heavyrain" }, "details": { "precipitation_amount": 5.0, "precipitation_amount_min": 2.0, "precipitation_amount_max": 8.0 } }
                }
            },
            {
            ...
            },
            {
                ...
                // En typisk ettermiddagsblokk for 6t-oppsummering
            ...
            },
            {
                ...
                // Her bikker Nepal over til Onsdag!
            ...
            {
                // UTC 09:00 -> Oslo 10:00 (Onsdag formiddag)
